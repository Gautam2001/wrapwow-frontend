...
const AdminSignup = () => {
  ...
  return (
    <div className="ad-su-page">
      <div className="ad-su-container">
        <div className="ad-su-brand-title">
          <img src={BrandLogo} alt="Brand Logo" className="ad-su-brand-logo" />
        </div>
        <form onSubmit={handleSignup}>
          <h2 className="ad-su-title">ADMIN SIGNUP</h2>

          <div className="ad-su-form">
            <label className="ad-su-label">Name:</label>
            <input
              className="ad-su-field"
              type="text"
              name="name"
            ...
            <label className="ad-su-label">Email:</label>
            <input
              className="ad-su-field"
              type="email"
              name="email"
            ...
            <label className="ad-su-label">Password:</label>
            <input
              className="ad-su-field"
              type="password"
              name="password"
            ...
            <label className="ad-su-label">Date of Birth:</label>
            <input
              className="ad-su-field ad-su-date"
              type="date"
              name="dob"
              value={form.dob}
              onChange={handleChange}
          ...
          <div className="ad-su-buttons">
            <button className="ad-su-submit-button" type="submit">
              Signup
            </button>
            <button
              className="ad-su-login-button"
              type="button"
